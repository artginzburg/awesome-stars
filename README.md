...
- [lujjjh/LinearMouse](https://github.com/lujjjh/LinearMouse) - A macOS mouse utility. Customizable scrolling direction, scrolling acceleration, cursor acceleration, cursor sensitivity…And, universal back & forward.
